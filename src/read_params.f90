...
do i = 1, nphase 
    call AdvanceToNextInputLine(4, line)
    read(4,*,err=1000) irheol(i),visc(i),den(i),alfa(i),beta(i),pln(i),acoef(i),eactiv(i),vactiv(i),rl(i), &
         rm(i),plstrain1(i),plstrain2(i),fric1(i),fric2(i),cohesion1(i),cohesion2(i), &
         dilat1(i),dilat2(i), &
...
line = line + 1
call AdvanceToNextInputLine(4, line)
read(4,*,err=1000) itype_melting, nelem_serp, prod_magma, rho_magma, prod_magma2
line = line + 1
call AdvanceToNextInputLine(4, line)
